    ...
    <div className="home">
      ...
      <div className="wrap bg-dark p-3 my-16 w-full">
        ...
        <div className="cards w-full max-w-40 p-6 flex justify-center items-center flex-wrap">
          ...
          <img className="p-4 select-none absolute right-0 fill-current text-pink max-w-xs" src={dots} alt="dots"/>
        </div>
      </div>
      ...
      <div className="w-full p-8 my-16 text-white">
          ...
          <p className="text-md my-12 text-left m-auto max-w-screen-md">Skinre is a chrome extension + website created to help people find suitable products to treat stuff such as acne and skin damage. Skinre has the sole purpose to help people deal with these day to day issues.</p>
      </div>
			<Footer />
    </div>
  ) 
